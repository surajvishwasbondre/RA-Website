...
public class TestBase {
	...
	public TestBase(){
		...
		FileInputStream ip=new FileInputStream("/RAWebsite/src/test/resources/config.properties");//2
		prop.load(ip);//3
	...
	PropertyConfigurator.configure("/RAWebsite/src/test/resources/log4j.properties");//2
